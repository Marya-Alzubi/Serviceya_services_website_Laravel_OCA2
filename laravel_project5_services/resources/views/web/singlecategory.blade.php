 ...
 <section id="service" class="services-area">
    <div class="container">
      <div class="row justify-content-center">
        @foreach ($specific_applicants as $applicants)
                ...
                <div class="single-pricing mt-40">
                   ...
                   {{-- {{$categories->cat_desc}} --}}
                    ...
                    <div class="pricing-btn text-center">
                         {{-- <a class="main-btn" href="singleapplicant/{{$applicants->applicant_id}}">Know More</a> --}}
                         <a class="main-btn" href="{{route('singleapplicant',$applicants->applicant_id)}}">Know More</a>
                    </div>
